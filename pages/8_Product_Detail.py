...
from utils.data_store import (
    ...
    get_seller_rating, format_stars,
)
...
# -------------------- Descriptions --------------------
# Always show English + Hindi. If the buyer's preferred language (set in
# Profile Settings) is something else, add a third tab that translates
# the English description into it on demand, via Gemini -- cached per
# session so repeat views don't re-call the API.
